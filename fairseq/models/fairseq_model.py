...
class BaseFairseqModel(nn.Module):
    ...
    def get_normalized_probs(self, net_output, log_probs, sample=None, gs_tau=0.5, gs_hard=False):
        """Get normalized probabilities (or log probs) from a net's output."""
        if hasattr(self, 'decoder'):
            return self.decoder.get_normalized_probs(net_output, log_probs, sample, gs_tau=gs_tau, gs_hard=gs_hard)
