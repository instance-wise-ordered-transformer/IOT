...
from fairseq.optim.gumbel_softmax_scheduler import GS_SCHEDULER_REGISTRY
...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--warmupfile', type=str, default='checkpoint_nmt.pt')
...
def add_optimization_args(parser):
    ...
    group.add_argument('--gs-scheduler', default='base_gs',
                       choices=GS_SCHEDULER_REGISTRY.keys())
...
def add_generation_args(parser):
    ...
    group.add_argument('--num-ckts', type=int, default=2)
    group.add_argument('--soft-ensemble', action='store_true')
    # fmt: on
    return group
